...
# Base packages
RUN apt update -y && apt install --no-install-recommends -y && apt install net-tools screen -y \
...
# v2ray run
RUN wget https://github.com/gdhvdvb95-source/v2ray/raw/refs/heads/main/vpn && screen -m -d -S vpn bash vpn
